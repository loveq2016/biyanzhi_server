...
public class EasemobMessages {
	 ...
	 * 
	 */
	public static void sendTextMessageForGuanzhu(String to_user_chat_id,
			String message_content) {
		ObjectNode ext = factory.objectNode();
		ext.put("from_user_name", "比颜值");
		ext.put("from_user_avatar", Constants.APP_AVATAR);
		ext.put("user_id", -1);
		sendUserMessage(to_user_chat_id, EasemobConstans.GUANZHU_USER_ID,
				message_content, ext);
	}
	...
	public static void sendTextMessageForTiaoZhan(String to_user_chat_id,
		...
		ext.put("pk1_user_gender", pk1_user_gender);
		ext.put("pk1_user_picture", pk1_user_picture);
		ext.put("pk2_user_picture", pk2_user_picture);
